...
{
    [self setImageWithURL:url placeholderImage:placeholder Size:size options:0 progress:nil completed:nil];
}
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder Size:(CGSize)size options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletedBlock)completedBlock
{
    [self cancelCurrentImageLoad];
